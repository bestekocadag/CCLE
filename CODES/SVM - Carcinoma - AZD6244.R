...
setwd(paste0(output_dir,"/","carcinoma","/","AZD6244"))

data2 <- read.delim("AZD6244 - Expression Data (IC50) - Normalized.tsv")
head(data2)
dim(data2)
...
write.table(Predict_IC50_Train_SVM,
            "C:/Users/MONSTER/Desktop/TEZ/CCLE/DENEME/SVM-Carcinoma-AZD6244-Train-IC50-Predict.tsv",
            row.names = FALSE,
            quote = FALSE,
            sep = "\t")
...
write.table(SVM_RESULT_TABLE,
            "C:/Users/MONSTER/Desktop/TEZ/CCLE/DENEME/SVM-Carcinoma-AZD6244-Result.tsv",
            row.names = FALSE,
            quote = FALSE,
            sep = "\t")
...
write.table(Predict_IC50_Test_SVM,
            "C:/Users/MONSTER/Desktop/TEZ/CCLE/DENEME/SVM-Carcinoma-AZD6244-Test-IC50-Predict.tsv",
            row.names = FALSE,
            quote = FALSE,
            sep = "\t")
